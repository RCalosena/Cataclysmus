...
events.register(function(event as crafttweaker.event.EntityLivingEquipmentChangeEvent){
	...
	if (!hasEarlyArmor(helmet, chestplate, leggings, boots) || !wildcards.isWithinLimit(player)) { return; }
...
events.register(function(event as crafttweaker.event.EntityLivingEquipmentChangeEvent){
	...
	if (!hasMidArmor(helmet, chestplate, leggings, boots) || !wildcards.isWithinLimit(player)) { return; }
...
events.register(function(event as crafttweaker.event.EntityLivingEquipmentChangeEvent){
	...
	if (!hasPreCArmor(helmet, chestplate, leggings, boots) || !wildcards.isWithinLimit(player)) { return; }
...
events.register(function(event as crafttweaker.event.EntityLivingEquipmentChangeEvent){
	...
	if (!hasCArmor(helmet, chestplate, leggings, boots) || !wildcards.isWithinLimit(player)) { return; }
...
events.register(function(event as crafttweaker.event.EntityLivingEquipmentChangeEvent){
	...
	if (!hasRArmor(helmet, chestplate, leggings, boots) || !wildcards.isWithinLimit(player)) { return; }
...
events.register(function(event as crafttweaker.event.EntityLivingEquipmentChangeEvent){
	...
	if (!hasMArmor(helmet, chestplate, leggings, boots) || !wildcards.isWithinLimit(player)) { return; }
...
events.register(function(event as crafttweaker.event.EntityLivingEquipmentChangeEvent){
	...
	if (!hasEArmor(helmet, chestplate, leggings, boots) || !wildcards.isWithinLimit(player)) { return; }
